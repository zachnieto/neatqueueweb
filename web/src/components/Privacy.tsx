    ...
    return (
        <div className="flex justify-center items-center h-screen flex-col gap-3">
            ...
            <h2 className="text-xl">
                By using the NeatQueue website and Discord bot, you agree that
                you have read and agree to this policy. This policy is subject
            ...
            <ul className="list-disc text-xl">
                ...
                <li>
                    Reach out via the support server to request deletion of
                    other data
                </li>
            </ul>
        </div>
