...
const Instance = ({
    ...
    const [terminateModalOpen, setTerminateModalOpen] =
                    ...
                    (!privateInstance || !timeLeft ? (
                        ...
                        <div>
                            <h3 className="text-center">
                                For Another {timeLeft.days} Days,{' '}
                                {timeLeft.hours} Hours, and {timeLeft.minutes}{' '}
                                Minutes
                            </h3>
                            ...
                            <h1 className="text-2xl text-center mb-5">
                                ...
                                <span
                                    className={
                                        statusColor[
                                            privateInstance.bot as keyof typeof statusColor
                                        ]
                                    }
                                >
            ...
            {privateInstance && (
                <>
                    <Modal
                        ...
                        submitText="Confirm"
                        component={
                            <ExtendModal price={privateInstance?.price} />
                        }
                    />
                    <Modal
                        onSubmit={terminate}
